...
class batch_request : public ::google::protobuf::Message {
 public:
  ...
  inline const ::request& batch(int index) const;
  inline ::request* mutable_batch(int index);
  inline ::request* add_batch();
 ...
 private:
  ...
  ::google::protobuf::RepeatedPtrField< ::request > batch_;
...
class batch_response : public ::google::protobuf::Message {
 public:
  ...
  inline void clear_batch();
  static const int kBatchFieldNumber = 1;
  inline const ::response& batch(int index) const;
  inline ::response* mutable_batch(int index);
  inline ::response* add_batch();
 ...
 private:
  ...
  ::google::protobuf::RepeatedPtrField< ::response > batch_;
...
inline const ::request& batch_request::batch(int index) const {
  return batch_.Get(index);
}
inline ::request* batch_request::mutable_batch(int index) {
  return batch_.Mutable(index);
}
inline ::request* batch_request::add_batch() {
  return batch_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::request >&
...
inline const ::response& batch_response::batch(int index) const {
  return batch_.Get(index);
}
inline ::response* batch_response::mutable_batch(int index) {
  return batch_.Mutable(index);
}
inline ::response* batch_response::add_batch() {
  return batch_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::response >&
