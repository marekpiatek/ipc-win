...
class batch_request : public ::google::protobuf::Message {
 public:
  ...
  inline const ::request& requests(int index) const;
  inline ::request* mutable_requests(int index);
  inline ::request* add_requests();
 ...
 private:
  ...
  ::google::protobuf::RepeatedPtrField< ::request > requests_;
...
class batch_response : public ::google::protobuf::Message {
 public:
  ...
  inline const ::response& responses(int index) const;
  inline ::response* mutable_responses(int index);
  inline ::response* add_responses();
  inline const ::google::protobuf::RepeatedPtrField< ::response >&
      responses() const;
  inline ::google::protobuf::RepeatedPtrField< ::response >*
      mutable_responses();
  
  // @@protoc_insertion_point(class_scope:batch_response)
 private:
  
  ::google::protobuf::UnknownFieldSet _unknown_fields_;
  
  ::google::protobuf::RepeatedPtrField< ::response > responses_;
...
// repeated .request requests = 1;
inline int batch_request::requests_size() const {
  return requests_.size();
}
inline void batch_request::clear_requests() {
  requests_.Clear();
}
inline const ::request& batch_request::requests(int index) const {
  return requests_.Get(index);
}
inline ::request* batch_request::mutable_requests(int index) {
  return requests_.Mutable(index);
}
inline ::request* batch_request::add_requests() {
  return requests_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::request >&
batch_request::requests() const {
  return requests_;
}
inline ::google::protobuf::RepeatedPtrField< ::request >*
batch_request::mutable_requests() {
  return &requests_;
}
...
// repeated .response responses = 1;
inline int batch_response::responses_size() const {
  return responses_.size();
}
inline void batch_response::clear_responses() {
  responses_.Clear();
}
inline const ::response& batch_response::responses(int index) const {
  return responses_.Get(index);
}
inline ::response* batch_response::mutable_responses(int index) {
  return responses_.Mutable(index);
}
inline ::response* batch_response::add_responses() {
  return responses_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::response >&
batch_response::responses() const {
  return responses_;
}
inline ::google::protobuf::RepeatedPtrField< ::response >*
batch_response::mutable_responses() {
  return &responses_;
}
